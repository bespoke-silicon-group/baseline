...
int __attribute__ ((noinline)) kernel_vector_add_single_tile(  TA * __restrict__ A,   TB * __restrict__ B,   TC * __restrict__ C,
                      uint32_t WIDTH) {
 ...
 */
template <typename TA, typename TB, typename TC>
int __attribute__ ((noinline)) kernel_vector_add_single_1D_tile_group(TA * __restrict__ A,   TB * __restrict__ B,   TC * __restrict__ C,
                      uint32_t WIDTH) {
 ...
 */
template <typename TA, typename TB, typename TC>
int __attribute__ ((noinline)) kernel_vector_add_single_2D_tile_group(TA * __restrict__ A,   TB * __restrict__ B,   TC * __restrict__ C,
                      uint32_t WIDTH) {
 ...
 */
template <typename TA, typename TB, typename TC>
int __attribute__ ((noinline)) kernel_vector_add_1D_grid_2D_tile_groups(TA * __restrict__ A,   TB * __restrict__ B,   TC * __restrict__ C,
