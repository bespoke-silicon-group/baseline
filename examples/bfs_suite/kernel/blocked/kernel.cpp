...
template <typename TO_FUNC , typename APPLY_FUNC> __attribute__ ((noinline)) int edgeset_apply_pull_parallel_from_vertexset_to_filter_func_with_frontier(vertexdata *in_vertices , int *in_neighbors, int * frontier, int * next_frontier, int * parent, TO_FUNC to_func, APPLY_FUNC apply_func, int V, int E, int block_size_x)
{
  int BLOCK_SIZE = 32;
